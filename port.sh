...
mkdir -p port_tmp/overlay/framework/smali/android/telephony
cp -r port_tmp/framework.jar.out/smali/android/telephony/* port_tmp/overlay/framework/smali/android/telephony
...
mkdir -p port_tmp/overlay/framework2/smali/com/android/internal/telephony
cp -r port_tmp/framework2.jar.out/smali/com/android/internal/telephony/* port_tmp/overlay/framework2/smali/com/android/internal/telephony
mkdir -p port_tmp/overlay/framework2/smali/miui/telephony
cp -r port_tmp/framework2.jar.out/smali/miui/telephony/* port_tmp/overlay/framework2/smali/miui/telephony
...
mkdir -p port_tmp/overlay/telephony-common/smali/
cp -r port_tmp/telephony-common.jar.out/smali/* port_tmp/overlay/telephony-common/smali/
